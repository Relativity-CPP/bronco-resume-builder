...
import { ContactInfoService } from 'src/app/contact-info/contact-info.service';
...
export const experiences = [
  ...
  },
  {
    isCurrent: false,
    summary:
      'Full-stack developer working with Angular, Node and TypeScript. Working for the iShares platform. Emphasis ' +
      'on Dev-ops and developing the continous integration pipeline.',
  ...
  },
  {
    ...
    summary:
      ...
      '\n\nCreated a log analysis web application with the Play Framework in Java, incorporating Test Driven Development.' +
      ' It asynchronously uploads and processes large (2 GB) log files, and outputs meaningful results in context with the problem.' +
      ' \n\nAnalysis  and  development  of  the payment system infrastructure and user accounts section to be used by several clients ' +
      'of the company such as Waitrose, Tally Weijl, DJ Sports, Debenhams, Ann Summers, John Lewis and others.' +
...
export const education = [
  ...
  },
  {
    ...
    notes:
      'Exam Results: 2:1, Dissertation: 1st Class with Distinction\n\nRelevant courses: C Programming, ' +
      'Mathematics and Business for Engineers.',
